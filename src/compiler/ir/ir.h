...
typedef enum {
    ...
    // Option operations
    IR_OPTION_SOME,     // Create Some(value) option
    IR_OPTION_NONE,     // Create None option
    IR_OPTION_IS_SOME,  // Check if option is Some
    IR_OPTION_UNWRAP,   // Unwrap Some value
    IR_OPTION_UNWRAP_OR, // Unwrap Some value or return default
    
    // Result operations
    IR_RESULT_OK,       // Create Ok(value) result
    IR_RESULT_ERR,      // Create Err(error) result
    IR_RESULT_IS_OK,    // Check if result is Ok
    IR_RESULT_UNWRAP,   // Unwrap Ok value
    IR_RESULT_UNWRAP_OR, // Unwrap Ok value or return default
...
typedef struct IRBlock {
    ...
    // Bytecode generation
    size_t bytecode_offset;         // Byte offset in generated bytecode
} IRBlock;
